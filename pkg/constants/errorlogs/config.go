...
const (
	...
	GetSpamReportError         = "got error while getting the spam report. error :: %s"
	GetSpamError               = "got error while getting the spam report. error :: %v"
	ReportSpamError            = "got error while reporting the spam. error :: %v"
	MissingQueryParameterError = "got error while parsing the query parameter. error :: %s"
	DatabaseQueryError         = "got error while querying the database. error :: %v"
)
